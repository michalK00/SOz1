...
public class SecondStrategy extends Algorithm implements AlgorithmInterface{


    private int cpuLoadBound;

    public SecondStrategy(ArrayList<CPU> cpuList, int cpuLoadBound) {
        super(cpuList);
    ...
    public void simulate() {
        ...
        utils.createOutputChart(cpuStats, "two");
    }
